...
def _date_list(args: argparse.Namespace) -> list[str]:
    ...
    return [str(date.date()) for date in pd.date_range(args.start_date, args.end_date, freq="D")]
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=("Prepare a filtered, labeled opening research dataset partitioned by date.")
    )
