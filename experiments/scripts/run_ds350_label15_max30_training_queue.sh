...
# Run one 8-fold label job at a time: at most eight GPUs are active. The job
# names and output root are intentionally disjoint from the max-10 baseline.
JOBS=(
  os-nn-ds350-m30-w0931-h1m-v1
  os-nn-ds350-m30-w0931-h3m-v1
  os-nn-ds350-m30-w0931-h5m-v1
  os-nn-ds350-m30-w0931-h10m-v1
  os-nn-ds350-m30-w0931-h1h-v1
  os-nn-ds350-m30-w0931-hclose-v1
  os-nn-ds350-m30-w1001-h1m-v1
  os-nn-ds350-m30-w1001-h3m-v1
  os-nn-ds350-m30-w1001-h5m-v1
  os-nn-ds350-m30-w1001-h10m-v1
  os-nn-ds350-m30-w1001-h1h-v1
  os-nn-ds350-m30-w1001-hclose-v1
  os-nn-ds350-m30-w1401-h1m-v1
  os-nn-ds350-m30-w1401-h3m-v1
