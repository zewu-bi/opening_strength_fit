...
# Preserve the already-running 12-job order, then append the three 5m labels.
# Each label is one 8-shard Indexed Job, so at most eight GPUs are active.
JOBS=(
  ...
  os-nn-ds350-w1001-h5m-v2
  os-nn-ds350-w1401-h5m-v2
)
...
CURRENT_JOB=""
echo "all 15 ds350 label jobs completed"
