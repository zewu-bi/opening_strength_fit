...
MODEL_CONFIG = (
    RUNS
    / "nn_delay2_36m_2022_2025_auction_fresh_pruned_grouped_gated_v2_mech_v3_gelu_mse_v1.toml"
)
...
def test_target_configs_only_write_new_mixed_cache() -> None:
    for year in range(2019, 2026):
        config = _load(
            RUNS / f"build_delay2_{year}_auction_fresh_mixed_w030_target_v1.toml"
        )
